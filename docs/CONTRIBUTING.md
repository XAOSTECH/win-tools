...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/win-tools.git`
3. Add upstream remote: `git remote add upstream https://github.com/XAOSTECH/win-tools.git`
...
Feel free to open a [Discussion](https://github.com/XAOSTECH/win-tools/discussions) for questions or ideas.
